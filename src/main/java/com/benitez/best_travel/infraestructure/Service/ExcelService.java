...
import com.benitez.best_travel.infraestructure.abstract_services.ReportService;
...
public class ExcelService implements ReportService {
    ...
    private static int getTotalPurchase(Customer customer) {
        return customer.getTotalLandings() + customer.getTotalFlights() + customer.getTotalTours();
    }
